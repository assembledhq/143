ALTER TABLE IF EXISTS pr_readiness_bypasses DROP CONSTRAINT IF EXISTS pr_readiness_bypasses_changeset_scope_fkey, DROP COLUMN IF EXISTS changeset_id;
ALTER TABLE IF EXISTS pr_readiness_checks DROP CONSTRAINT IF EXISTS pr_readiness_checks_changeset_scope_fkey, DROP COLUMN IF EXISTS changeset_id;
DO $$
BEGIN
...
END
$$;
ALTER TABLE IF EXISTS pr_readiness_runs DROP CONSTRAINT IF EXISTS pr_readiness_runs_changeset_scope_fkey, DROP COLUMN IF EXISTS evaluated_head_sha, DROP COLUMN IF EXISTS changeset_id;
