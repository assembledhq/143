...
STATIC_EGRESS_NETWORK="${STATIC_EGRESS_NETWORK:-${SANDBOX_STATIC_EGRESS_NETWORK:-143-sandbox-static-egress}}"
STATIC_EGRESS_SUBNET="${STATIC_EGRESS_SUBNET:-172.31.0.0/24}"
STATIC_EGRESS_RESOLV_CONF="${STATIC_EGRESS_RESOLV_CONF:-${SANDBOX_STATIC_EGRESS_RESOLV_CONF:-/etc/143/sandbox-static-egress-resolv.conf}}"
STATIC_EGRESS_DNS_IP="${STATIC_EGRESS_DNS_IP:-172.31.0.2}"
STATIC_EGRESS_ENABLED="${STATIC_EGRESS_ENABLED:-false}"
STATIC_EGRESS_CAPABILITY_FILE="${STATIC_EGRESS_CAPABILITY_FILE:-/etc/143/static-egress-capable}"
