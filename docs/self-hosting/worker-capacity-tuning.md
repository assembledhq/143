...
`max_concurrent_runs` is the shared org-level execution policy for interactive
and code-review turns in app settings; it is not a host-capacity bucket knob.
