...
| `make demo-seed-check` | Validate `.143/seed.sql` against a temporary migrated database |
| `make demo-seed-apply` | Apply `.143/seed.sql` to an explicit guarded demo database target |
