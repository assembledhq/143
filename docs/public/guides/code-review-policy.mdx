...
The **Scheduled reviews** section shows pending work before a session exists,
including draft, paused, active-review, and GitHub availability waits. Its queue
is separate from the executed review activity filters. Members and admins can
pause or resume automatic monitoring for a pending PR.
