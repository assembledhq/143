...
The author change summaries show their captured sample size. New reviews persist additions and deletions separately, along with structured non-approval reasons used for the decision. Older reviews may not contribute to either breakdown, so treat a small historical sample as directional rather than representative.
