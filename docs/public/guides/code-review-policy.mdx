...
After someone requests 143 Code Reviewer once, new commits and human review activity durably trigger a new assessment until 143 approves the PR. This includes review submissions, edits, and dismissals; inline review comment changes; and resolved or reopened review threads. PR title or description edits, readiness changes, completed checks, and commit-status updates continue to update normal PR metadata and health, but do not start another review session. The existing GitHub review summary is updated in place after a supported reassessment, while the Code reviews page retains each assessment as audit history.
