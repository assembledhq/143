...
<FlowDiagram
  items={["Caddy and TLS", "Frontend and API/worker", "Postgres and Redis", "Chrome and sandbox DNS", "Docker/gVisor sandboxes"]}
  caption="Everything runs on one host. That keeps evaluation simple, but restarts and resource pressure affect the whole stack."
/>
