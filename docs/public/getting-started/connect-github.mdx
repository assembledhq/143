...
<Screenshot
  src="/product/docs-github-app.webp"
  alt="143 integrations settings showing the GitHub App and personal GitHub account connected"
  width={1064}
  height={312}
  caption="The GitHub App is the required repository integration. Other tools can be connected later when a workflow needs them."
/>
