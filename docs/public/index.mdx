...
- **Useful integrations:** Start work from GitHub, Linear, Slack, or an API, and let agents query connected systems such as Sentry, logs, Slack, Notion, GitHub, and CI through `143-tools`.
