...
> 1. Apply migrations `000102` and `000103`. The legacy tables are untouched.
...
> 4. Rollback: `make migrate-down` reverses 000103 (deletes from `coding_credentials`) and 000102 (drops the table). Legacy data is intact.
