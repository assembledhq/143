...
- [x] M1: Skip unnecessary dependency/bootstrap work for built-in reviews. Implementation and Claude milestone review are complete; missing-artifact replay and production measurement remain rollout gates.
- [ ] M2: Preserve the workspace across reviewer-to-synthesis handoff.
