...
Advisory pre-dispatch placement has a default-off `CODE_REVIEW_EXECUTOR_PLACEMENT_ENABLED` switch. Enable it after the worker fleet has the matching node-claim predicate.
