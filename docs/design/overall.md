...
- Slack is a first-class collaboration surface for mentions, bot DMs, App Home, explicit per-user org selection in multi-org workspaces, human-input responses, session notifications, preview controls, PR actions, and notification fanout while 143 remains the canonical transcript and execution system. See [future/92-slackbot-product-surface.md](future/92-slackbot-product-surface.md) and [future/101-slackbot-implementation-plan.md](future/101-slackbot-implementation-plan.md).
