...
- Settings pages should not rely on desktop-only table layouts on phones. Shared headers should give actions a full-width mobile lane, and dense settings lists should collapse into stacked rows/cards with inline labels instead of forcing horizontal scanning. Detailed implementation: [implemented/70-mobile-friendly-settings-pages.md](implemented/70-mobile-friendly-settings-pages.md).
