...
- Text selection must remain legible on saturated transcript surfaces. User message bubbles keep their primary gradient treatment, but selected text inside them uses an inverse card/card-foreground selection layer instead of the global primary selection wash so selection contrast does not collapse on primary-colored backgrounds.
