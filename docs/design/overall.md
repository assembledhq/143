...
- Slack is a first-class collaboration surface for bot mentions, DMs, human-input delivery, session notifications, and preview/PR controls. Slack stays a lightweight thread surface while canonical transcripts, diffs, previews, PR state, and logs remain in 143. See [future/92-slackbot-product-surface.md](future/92-slackbot-product-surface.md) and [future/101-slackbot-implementation-plan.md](future/101-slackbot-implementation-plan.md).
