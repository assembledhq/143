...
- Step 3: Execute a coding agent
    ...
    - Sessions are the execution primitive and should be able to exist with **zero, one, or many linked issues**. Issues remain backlog/prioritization records; sessions own execution state, conversation history, sandbox state, and review/PR flow. The future migration design lives in [future/59-session-issue-decoupling-and-multi-issue-linking.md](future/59-session-issue-decoupling-and-multi-issue-linking.md).
