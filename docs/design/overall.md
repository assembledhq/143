...
- Session detail should not rely on a dedicated bottom metadata footer. Turn/status/diff context belongs in the main header, review, and transcript surfaces so the follow-up composer stays the terminal affordance on desktop and mobile.
