...
- Slack is a first-class collaboration surface for mentions, bot DMs, App Home, human-input responses, preview controls, PR actions, and notification fanout while 143 remains the canonical transcript and execution system. See [future/101-slackbot-implementation-plan.md](future/101-slackbot-implementation-plan.md).
