...
This handles repo access, PR creation, and webhooks. See [guides/github-app-setup.md](guides/github-app-setup.md) for the full walkthrough with permissions and events. The short version:
...
3. Set permissions and events per [guides/github-app-setup.md](guides/github-app-setup.md)
...
| "Resource not accessible by integration" | App is missing a permission — check [guides/github-app-setup.md](guides/github-app-setup.md) |
