...
func TestLoad_UsesDefaults(t *testing.T) {
	...
	require.Equal(t, 1, cfg.WorkerInteractiveReservedSandboxes, "Load should reserve one worker sandbox for interactive turns by default")
...
func TestLoad_UsesEnvironmentOverrides(t *testing.T) {
	...
	t.Setenv("WORKER_INTERACTIVE_RESERVED_SANDBOXES", "2")
	...
	require.Equal(t, 2, cfg.WorkerInteractiveReservedSandboxes, "Load should parse WORKER_INTERACTIVE_RESERVED_SANDBOXES from the environment")
