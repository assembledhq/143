...
{{ .Title }}`
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.Contains(t, orchestrator, "Only P0 and P1 issues may become GitHub inline comments.", "orchestrator should restrict inline comments to blocking findings")
