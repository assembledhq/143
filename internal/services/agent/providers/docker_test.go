			...
			return []container.Summary{
				{
					...
					Labels: map[string]string{
						...
						SandboxLabelPreparationLeaseToken: "lease-1",
...
func TestDockerProvider_Create(t *testing.T) {
	...
	t.Run("labels managed sandbox containers with tracing metadata", func(t *testing.T) {
		...
		cfg.PreparationLeaseToken = "lease-789"
		...
		require.Equal(t, "lease-789", capturedLabels[SandboxLabelPreparationLeaseToken], "unpublished preparation containers should identify their owning attempt")
...
func TestDockerProvider_Snapshot(t *testing.T) {
	...
	t.Run("tars workdir plus agent state dirs under HomeDir", func(t *testing.T) {
		...
		require.Contains(t, tarCmd, "'home/sandbox/.local/share/opencode'", "tar should include OpenCode's data dir under HomeDir for native session resume")
		require.Contains(t, tarCmd, "--exclude='home/sandbox/.local/share/opencode/auth.json'", "tar should exclude OpenCode auth material")
		require.Contains(t, tarCmd, "--exclude='home/sandbox/.local/share/opencode/account.json'", "tar should exclude OpenCode account material")
		require.Contains(t, tarCmd, "--exclude='home/sandbox/.local/share/opencode/mcp-auth.json'", "tar should exclude OpenCode MCP auth material")
		require.Contains(t, tarCmd, "--exclude='home/sandbox/.local/share/opencode/log'", "tar should exclude OpenCode logs")
		require.Contains(t, tarCmd, "--exclude='home/sandbox/.local/share/opencode/repos'", "tar should exclude OpenCode repo caches")
