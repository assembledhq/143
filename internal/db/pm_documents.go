...
func (s *PMDocumentStore) ListDocumentSetPins(ctx context.Context, orgID uuid.UUID) ([]models.PMDocumentSetPin, error) {
	rows, err := s.db.Query(ctx,
		`SELECT id, org_id, created_at FROM pm_document_set_pins WHERE org_id = @org_id ORDER BY created_at DESC LIMIT 100`,
		pgx.NamedArgs{"org_id": orgID},
	)
	if err != nil {
