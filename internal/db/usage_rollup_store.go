...
func usageAgentLabel(agentType string) string {
...
func usageReasoningLabel(reasoning string) string {
	switch reasoning {
	case "default":
		return "Default"
	case "xhigh":
...
func usageModelLabel(model string) string {
	...
	switch model {
	case models.CodexModelGPT55:
		return "GPT-5.5"
	case models.CodexModelGPT54:
		return "GPT-5.4"
	case models.CodexModelGPT54Mini:
		return "GPT-5.4 Mini"
	case models.CodexModelGPT5Codex:
		return "GPT-5 Codex"
	case models.CodexModelGPT53Codex:
		return "GPT-5.3 Codex"
	case models.CodexModelGPT52Codex:
		return "GPT-5.2 Codex"
	case models.ClaudeCodeModelOpus47:
		return "Claude Opus 4.7"
	case models.ClaudeCodeModelOpus46:
		return "Claude Opus 4.6"
	case models.ClaudeCodeModelSonnet46:
		return "Claude Sonnet 4.6"
	case models.ClaudeCodeModelSonnet45:
		return "Claude Sonnet 4.5"
	case models.ClaudeCodeModelHaiku45:
		return "Claude Haiku 4.5"
	case models.GeminiCLIModelGemini25Pro:
...
func usageLabelForDimension(dimension, key string) string {
	switch dimension {
	case "agent":
		return usageAgentLabel(key)
	case "model":
		return usageModelLabel(key)
	case "reasoning":
		return usageReasoningLabel(key)
	default:
		return key
	}
}
