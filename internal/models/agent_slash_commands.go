...
// ClaudeCodeSlashCommands is the curated catalog of well-known Claude Code
// commands. Source: https://code.claude.com/docs/en/slash-commands.
var ClaudeCodeSlashCommands = []SlashCommand{
	...
	{Name: "agents", Description: "Manage Claude Code subagents"},
