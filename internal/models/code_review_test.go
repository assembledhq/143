...
func TestCodeReviewEnumsValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "size bucket small", validate: CodeReviewSizeBucketSmall.Validate},
		{name: "size bucket medium", validate: CodeReviewSizeBucketMedium.Validate},
		{name: "size bucket large", validate: CodeReviewSizeBucketLarge.Validate},
		{name: "size bucket extra large", validate: CodeReviewSizeBucketXLarge.Validate},
		{name: "size bucket invalid", validate: CodeReviewSizeBucket("bogus").Validate, expectErr: true},
