...
func TestAutomationRunHandler_HappyPath(t *testing.T) {
	...
	// as side-table context — asserting that specific value here proves the
	// handler linked the session back to the run it's servicing.
	...
	createSessionArgs := workerAnyArgs(38)
