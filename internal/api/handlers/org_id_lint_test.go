...
func TestHandlersMustUseOrgIDFromContext(t *testing.T) {
	...
	allowlist := map[string]string{
		...
		"PrivateConnectorHandler.RegisterInstance":       "public connector bootstrap; org comes from one-time deployment token",
		"PrivateConnectorHandler.Heartbeat":              "public connector daemon endpoint; org comes from signed instance identity lookup",
		"PrivateConnectorHandler.Session":                "public connector websocket; org comes from signed instance identity lookup",
		"PrivateConnectorHandler.RotateInstanceIdentity": "public connector daemon endpoint; org comes from signed current instance identity lookup",
