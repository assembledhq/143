...
func TestHandlersMustUseOrgIDFromContext(t *testing.T) {
	...
	allowlist := map[string]string{
		...
		"InternalPullRequestHandler.Update":                 "internal API, uses claims.OrgID and claims.SessionID after signed-token validation",
		...
		"InternalChangesetHandler.List":                     "internal sandbox API, shared authorization validates signed claims.OrgID and claims.SessionID before delegation",
		"InternalChangesetHandler.Status":                   "internal sandbox API, shared authorization validates signed claims.OrgID and claims.SessionID before delegation",
		"InternalChangesetHandler.Create":                   "internal sandbox API, shared authorization validates signed claims.OrgID and claims.SessionID before delegation",
		"InternalChangesetHandler.Materialize":              "internal sandbox API, shared authorization validates signed claims.OrgID and claims.SessionID before delegation",
		"InternalChangesetHandler.Verify":                   "internal sandbox API, shared authorization validates signed claims.OrgID and claims.SessionID before delegation",
		"InternalChangesetHandler.Diff":                     "internal sandbox API, shared authorization validates signed claims.OrgID and claims.SessionID before delegation",
		"InternalAgentPreviewHandler.Ensure":                "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Status":                "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Update":                "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Restart":               "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Stop":                  "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Observe":               "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Act":                   "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Screenshot":            "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Console":               "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Inspect":               "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Interact":              "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.MultiViewport":         "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.VisualDiff":            "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		"InternalAgentPreviewHandler.Assert":                "internal sandbox preview API, shared authorize path validates claims.OrgID and claims.SessionID",
		...
		"InternalCodeReviewHandler.List":                    "internal API, uses signed tool token claims.OrgID and restricts rows to claims.RepoID",
		...
		"ApplicationConfigHandler.Get":                        "returns process-wide rendering config captured at boot; reads no org-scoped data",
		"ApplicationConfigHandler.RecordSessionActivityEvent": "records bounded UI telemetry dimensions only; the body carries no identifiers and no store is touched",
