...
func TestPreviewDiagnosticReadsAreViewerReadableButMutationsAreBuilderOnly(t *testing.T) {
	...
	require.Greater(t, sessionObserveRoute, readGroupStart, "session observe should be available to preview readers")
	require.Less(t, sessionObserveRoute, builderGroupStart, "session observe should not require builder workflow access")
