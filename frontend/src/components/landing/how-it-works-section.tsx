      ...
      <div className="relative mx-auto max-w-5xl space-y-40 sm:space-y-52">
            ...
            >
              ...
              <div className="p-5 font-mono text-sm space-y-3">
                {[
                  ...
                  <div key={line.prefix} className="flex gap-3">
                ...
                <div className="flex gap-3 pt-1 text-white/20">
                  <span>{">"}</span>
                  <span>
              ...
              <div className="px-5 py-3">
                <div className="space-y-2.5">
                  {[
                    ...
                    { task: "Migrate middleware", status: "active" },
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-20">
          <div className="md:w-1/2 space-y-4">
            ...
            <p className={`text-sm leading-relaxed max-w-sm ${body}`}>
              Claude Code, Codex, Gemini CLI &mdash; the PM dispatches the task,
              your agent builds it, your CI validates it. Different engineers can
              use different agents on the same team.
            </p>
          </div>
          <div className="md:w-1/2 relative">
