  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-surface-raised dark:data-[state=active]:text-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-surface-selected data-[state=active]:text-foreground",
        ...
        "group-data-[size=sm]/tabs-list:data-[state=active]:shadow-none group-data-[size=sm]/tabs-list:data-[state=active]:border-transparent group-data-[size=sm]/tabs-list:data-[state=active]:bg-surface-selected dark:group-data-[size=sm]/tabs-list:data-[state=active]:border-transparent dark:group-data-[size=sm]/tabs-list:data-[state=active]:bg-surface-selected",
        className
      )}
      {...props}
    />
