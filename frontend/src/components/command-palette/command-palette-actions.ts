...
export const staticActions: PaletteAction[] = [
  ...
  // Quick actions
  { id: "action-new-session", label: "New session", icon: Plus, href: "/sessions/new", hiddenRoles: ["viewer"], group: "quick-actions" },
  ...
  { id: "action-new-project", label: "New project", icon: Plus, href: "/projects/new", preserveRepo: true, hiddenRoles: ["viewer", "builder"], group: "quick-actions" },
