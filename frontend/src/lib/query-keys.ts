...
export const queryKeys = {
  ...
  codeReviews: {
    ...
    policyVersions: ["code-reviews", "policy-versions"] as const,
    policyVersionList: (params?: unknown) => ["code-reviews", "policy-versions", params ?? null] as const,
    policyComparison: (newerId?: string, olderId?: string) => ["code-reviews", "policy-comparison", newerId ?? null, olderId ?? null] as const,
    githubTrigger: (repositoryId?: string | null) => ["code-reviews", "github-trigger", repositoryId ?? null] as const,
    githubTriggers: ["code-reviews", "github-triggers"] as const,
