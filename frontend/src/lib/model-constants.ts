...
export const CLAUDE_CODE_MODEL_OPUS_55 = "claude-opus-5-5";
...
export const CODEX_MODEL_GPT_6_SOL = "gpt-6-sol";
export const CODEX_MODEL_GPT_6_LUNA = "gpt-6-luna";
...
export const AVAILABLE_CODEX_MODELS = [
  ...
  CODEX_MODEL_GPT_6_SOL,
  CODEX_MODEL_GPT_6_LUNA,
...
export const OPENCODE_MODEL_CLAUDE_OPUS_46 = "anthropic/claude-opus-4-6";
...
// GPT-5.5 is NOT collapsed under a bare logical id because that bare name
// belongs to the Codex agent. OpenCode offers it as explicit physical (pinned)
// route ids instead. Mirrors the Go registry.

// Ordered logical model ids the OpenCode picker offers. GLM 5.2 leads as the
// default; after that, model families are grouped with newer versions first.
...
export const OPENCODE_MODEL_LABELS: Readonly<Record<string, string>> = {
  ...
  [OPENCODE_MODEL_CLAUDE_OPUS_46]: "Claude Opus 4.6",
};
