...
export const DEFAULT_PREVIEW_AUTO_POOL_MAX_ACTIVE = 4;
export const MIN_PREVIEW_AUTO_POOL_MAX_ACTIVE = 1;
export const MAX_PREVIEW_AUTO_POOL_MAX_ACTIVE = 20;
export const DEFAULT_PREVIEW_SESSION_PREWARM_MAX_ACTIVE = 0;
export const MIN_PREVIEW_SESSION_PREWARM_MAX_ACTIVE = 0;
export const MAX_PREVIEW_SESSION_PREWARM_MAX_ACTIVE = 25;
