...
export function SessionDetailContent({ id }: { id: string }) {
  ...
  }, [builderReviewAllowsPR, canCreatePR, createPRMutation, hasPR, hasSnapshot, isRunning, prStatus, pushChangesMutation, resumeActionParam, resumePRParam, session?.has_unpushed_changes]);
